                            ...
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <li><a href="{{ route('home') }}">Home</a></li>
                                     <li class="menu-item-has-children"><a href="{{ route('hotel-list') }}">Hotels</a>
                                        <ul class="sub-menu">
                                            @forelse ($all_hotels as $hotel )
                                                  <li><a href="{{ route('hotel-details',$hotel->slug) }}">{{ $hotel->hotel_name }}</a></li>
                    ...
                    <div class="header-right justify-content-end align-items-center">
                        <div class="header-button d-none d-xl-block">
                            <div class="d-none d-md-flex glo-header-btn-2">
                                <a class="glo-btn-anim btn-theme-3"
                                    href="{{ route('reservation-page') }}"><span>Reservation
