<section id="reservation" class="pt-10 pb-14">
    <div class="container">
        <div class="row g-0 g-lg-8" data-cue="fadeIn" data-show="true"
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="reservation.html"
                                class="fw-semibold text-secondary link-hover-primary d-inline-block">
                                <i class="hicon  hicon-line-close"></i>
                                <span>Edit</span>
                            </a>
                        </div>
                        <hr>
