        ...
        <div class="row align-items-center">
          <div class="col-xl-6 col-lg-6 col-sm-12">
            <div class="glo-about-thumb-wrapper p-relative ">
              ...
              <div class="glo-about-batch">
                <span><img src="{{ asset('logo/logo.jpeg')}}" alt="batch" style="width:150px;height:150px; border-radius:50%"></span>
              </div>
            </div>
          </div>
         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="glo-features-content-2 mb-60 revealed" data-reveal="">
              ...
              <div class="glo-features-mission revealed mt-5" data-reveal="">
