                             ...
                             <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model.lazy="email" type="email" class="form-control"
                                        placeholder="" id="email" autofocus >
                                </div>
                                @error('email') <div wire:key="form" class="error"> {{$message}} </div>
                                @enderror
                            </div>
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="password" type="password" placeholder=""
                                            class="form-control" id="password" aria-label="Password" aria-describedby="password-addon">

                                              {{-- <button type="button" class="btn btn-light shadow-none ms-0" type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button> --}}
                                    </div>
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('forgot') }}" class="small text-right">Forgot
                                            password?</a></div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-center">
                                {{-- <button type="submit" class="btn btn-primary btn-gray-800">Sign in</button> --}}
                                <x-general.button wire:click.prevent="login" class="btn btn-primary auth-btn"> Sign In </x-general.button>
                            </div>
                        </action=>
