 <header id="page-topbar">
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{ route('welcome') }}" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('logo/main.png') }}" alt="" height="24"> <span class="logo-txt"></span>
                                </span>
                            </a>
                            ...
                            <a href="{{ route('welcome') }}"class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img  src="{{ asset('logo/white-logo.png') }}"alt="" height="24"> <span class="logo-txt"></span>
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div wire:ignore.self class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{  asset('assets/images/users/avatar-1.jpg')}}"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium"> @auth{{  auth()->user()->firstname ? auth()->user()->firstname . ' ' . auth()->user()->lastname : 'User Name'}} @endauth</span>
