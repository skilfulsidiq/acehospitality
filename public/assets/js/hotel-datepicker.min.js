    ...
    class a {
        constructor(t, e) {
            ...
            (this.format = s.format || "YYYY-MM-DD"),
                ...
                (this.topbarPosition =
                    "bottom" === s.topbarPosition ? "bottom" : "top"),
                ...
                (this.submitButtonName =
                    this.submitButton && s.submitButtonName
                        ? s.submitButtonName
                        : ""),
                (this.i18n = s.i18n || {
                    selected: "Your stay:",
                ...
                (this.onSelectRange =
                    void 0 !== s.onSelectRange && s.onSelectRange),
                (this.extraDayText =
                    void 0 !== s.extraDayText && s.extraDayText),
                (this.input = t),
                this.init();
        }
        addBoundedListener(t, e, s, i) {
            ...
            const a = s.bind(this);
            this._boundedEventHandlers[t][e].push([a, i]),
            ...
            if (t in this._boundedEventHandlers) {
                ...
                if (e in s) {
                    ...
                    for (let s = i.length; s--; ) {
                        const a = i[s];
                        t.removeEventListener(e, a[0], a[1]);
                    }
                }
            }
        }
        ...
        createDatepickerDomString() {
            ...
            if (this.showTopbar) {
                ...
                this.clearButton &&
                    ...
                    t &&
                        (i +=
                            '<div class="datepicker__buttons">' + t + "</div>"),
                    (i += "</div>");
            }
            this.showTopbar && "top" === this.topbarPosition && (s += i),
                (s +=
            ...
            return (
                (s += "</div>"),
                this.showTopbar && "bottom" === this.topbarPosition && (s += i),
                (s +=
        ...
        showMonth(t, e) {
            ...
            const s = this.getMonthName(t.getMonth()),
                ...
                n = i.getElementsByTagName("tbody")[0];
        ...
        createMonthDomString(t) {
            ...
            let a = t.getDay();
            const n = t.getMonth();
            if ((0 === a && "monday" === this.startOfWeek && (a = 7), a > 0))
                for (let i = a; i > 0; i--) {
                    const a = new Date(t.getTime() - 864e5 * i);
                    (s = this.isValidDate(a.getTime())),
                        ((this.startDate &&
                            this.compareDay(a, this.startDate) < 0) ||
                            (this.endDate &&
                                this.compareDay(a, this.endDate) > 0)) &&
                            (s = !1),
                        e.push({
                            date: a,
                            type: "lastMonth",
            ...
            for (let i = 0; i < 40; i++) {
                ...
                (s = this.isValidDate(a.getTime())),
                    ...
                    e.push({
                        date: a,
                        type: a.getMonth() === n ? "visibleMonth" : "nextMonth",
                        day: a.getDate(),
                        time: a.getTime(),
                        valid: s,
                    });
            ...
            for (let t = 0; t < 6 && "nextMonth" !== e[7 * t].type; t++) {
                ...
                for (let s = 0; s < 7; s++) {
                    let a = "monday" === this.startOfWeek ? s + 1 : s;
                    a = e[7 * t + a];
                    const n = this.getDayClasses(a);
                    let h = "";
                    this.hasClass(a, "datepicker__month-day--no-checkin") &&
                        (h = this.i18n["checkin-disabled"]),
                        this.hasClass(
                            a,
                            "datepicker__month-day--no-checkout"
                        ) &&
                            (h && (h += ". "),
                            (h += this.i18n["checkout-disabled"]));
                    const r = {
                        daytype: a.type,
                        time: a.time,
                        class: n.join(" "),
                    ...
                    h && (r.title = h),
                        (r.role = "button"),
                        this.getDateString(a.time) ===
                            this.getDateString(new Date()) &&
                            (r.tabindex = "0");
                    let o = "";
                    this.extraDayText &&
                        (o = this.extraDayText(this.getDateString(a.time), r)),
                        (o = o || ""),
                        o &&
                            (r.class =
                                r.class + " datepicker__month-day--with-extra"),
                        (i +=
                            '<td class="' +
                            r.class +
                            '" ' +
        ...
        getDayClasses(t) {
            ...
            if (t.valid || "visibleMonth" === t.type) {
                ...
                if (this.disabledDates.length > 0) {
                    ...
                    this.disabledDates.indexOf(e) > -1
                        ...
                        t.valid &&
                            ...
                            this.compareDay(t.date, this.lastDisabledDate) >
                                0 &&
                            2 ===
                ...
                this.disabledDaysOfWeek.length > 0 &&
                    this.disabledDaysOfWeek.indexOf(s.format(t.time, "dddd")) >
                        -1 &&
                    ((t.valid = !1), (r = !0)),
            ...
            return [
                ...
                a ? "datepicker__month-day--disabled" : "",
                a && this.enableCheckout && 1 === this.isFirstDisabledDate
                    ? "datepicker__month-day--checkout-enabled"
                    : "",
                d ? "datepicker__month-day--before-disabled-date" : "",
                i || o ? "datepicker__month-day--checkin-only" : "",
                n ? "datepicker__month-day--no-checkin" : "",
        ...
        checkAndSetDayClasses() {
            ...
            for (let e = 0; e < t.length; e++) {
                ...
                const h = {
                    ...
                    r = this.getDayClasses(h);
                t[e].className = r.join(" ");
            }
        }
        ...
        showSelectedDays() {
            ...
            for (let e = 0; e < t.length; e++) {
                ...
                (this.start &&
                    ...
                    ? this.addClass(t[e], "datepicker__month-day--selected")
        ...
        showSelectedInfo() {
            ...
            const t = this.datepicker.getElementsByClassName(
                ...
                a = document.getElementById(this.getCloseButtonId()),
                n = document.getElementById(this.getClearButtonId()),
                h = document.getElementById(this.getSubmitButtonId());
            if (
                ((e.textContent = "..."),
                (s.textContent = "..."),
        ...
        isValidDate(t) {
            ...
            if (this.start && !this.end) {
                ...
                if (this.disabledDates.length > 0) {
                    const e = this.getClosestDisabledDates(
                        new Date(parseInt(this.start, 10))
                    );
                ...
                if (this.disabledDaysOfWeek.length > 0) {
                    const e = this.getClosestDisabledDays(
                        new Date(parseInt(this.start, 10))
                    );
                    if (e[0] && this.compareDay(t, e[0]) <= 0) return !1;
                    if (e[1] && this.compareDay(t, e[1]) >= 0) return !1;
        ...
        goToNextMonth(t) {
            ...
            const s = Number.isInteger(t) ? t : t.target.getAttribute("month"),
                i = s > 1;
            let a = i ? this.month2 : this.month1;
            return (
                (a = this.getNextMonth(a)),
                !(
                    (!this.isSingleMonth() &&
                        !i &&
                        this.compareMonth(a, this.month2) >= 0) ||
        ...
        goToPreviousMonth(t) {
            ...
            return (
                ...
                !(
                    (i && this.compareMonth(a, this.month1) <= 0) ||
                    this.isMonthOutOfRange(a)
                ) &&
                    ((!this.moveBothMonths && !e) ||
                        i ||
        ...
        updateSelectableRange() {
            ...
            for (let s = 0; s < t.length; s++)
                if (
                    (this.hasClass(t[s], "datepicker__month-day--invalid") &&
                        this.hasClass(t[s], "datepicker__month-day--tmp") &&
                        (this.removeClass(t[s], "datepicker__month-day--tmp"),
                        this.hasClass(t[s], "datepicker__month-day--tmpinvalid")
                            ? this.removeClass(
                                  t[s],
                    ...
                    if (
                        ...
                        (this.hasClass(t[s], "datepicker__month-day--valid") ||
                            this.hasClass(
                                t[s],
                        ...
                        this.isValidDate(e)
                            ? (this.addClass(
                              ...
                              this.addClass(t[s], "datepicker__month-day--tmp"),
                              this.removeClass(
                                  t[s],
                                  "datepicker__month-day--invalid"
                              ),
                    ...
                    (this.hasClass(
                        ...
                        (this.addClass(t[s], "datepicker__month-day--invalid"),
                        this.removeClass(t[s], "datepicker__month-day--valid"),
                        this.hasClass(
                            t[s],
                            "datepicker__month-day--before-disabled-date"
                        ) ||
        ...
        dayHovering(t) {
            ...
            if (!this.hasClass(t, "datepicker__month-day--invalid")) {
                const t = this.datepicker.getElementsByTagName("td");
                for (let s = 0; s < t.length; s++) {
                    const i = parseInt(t[s].getAttribute("time"), 10);
                    i === e
                        ? this.addClass(t[s], "datepicker__month-day--hovering")
                        : this.removeClass(
                              t[s],
            ...
            if (s) {
                const e = t.getBoundingClientRect(),
                    i = this.datepicker.getBoundingClientRect();
                let a = e.left - i.left,
                    n = e.top - i.top;
                a += e.width / 2;
                const h = document.getElementById(this.getTooltipId());
                (h.style.display = ""), (h.textContent = s);
                const r = h.getBoundingClientRect().width,
                    o = h.getBoundingClientRect().height;
                (a -= r / 2),
                    (n -= o),
                    setTimeout(() => {
                        (h.style.left = a + "px"), (h.style.top = n + "px");
                    }, 10);
            } else {
                document.getElementById(this.getTooltipId()).style.display =
                    "none";
        ...
        getClosestDisabledDates(t) {
            ...
            if (t < this.disabledDatesTime[0])
                ...
                const a = Math.abs(new Date(0, 0, 0).valueOf());
                let n,
                    h = a,
                    r = -a,
                    o = 0;
                for (n = 0; n < this.disabledDatesTime.length; ++n)
                    (o = t - this.disabledDatesTime[n]),
                        o < 0 && o > r && ((i = n), (r = o)),
                        o > 0 && o < h && ((s = n), (h = o));
        ...
        getDisabledDays() {
            const t = [],
                ...
                i = new Date();
            for (let e = 0; e < 7; e++) {
                const a = this.addDays(i, e);
                t[s.format(a, "d")] = s.format(a, "dddd");
            }
        ...
        getClosestDisabledDays(t) {
            const e = [!1, !1];
            for (let i = 0; i < 7; i++) {
                const a = this.substractDays(t, i);
                if (
                    this.disabledDaysIndexes.indexOf(
                        parseInt(s.format(a, "d"), 10)
                    ) > -1
                ) {
                    e[0] = a;
                    break;
        ...
        setDayAriaAttributes() {
            ...
            for (let e = 0; e < t.length; e++) {
                const i = t[e].className,
                    a = parseInt(t[e].getAttribute("time"), 10);
                let n = "false",
                    h = "";
                i.includes("datepicker__month-day--invalid")
                    ? ((h = this.replacei18n(
                          this.i18n["aria-disabled"],
                          s.format(a, this.ariaDayFormat)
                      )),
                      (n = "true"))
                    : (h = i.includes(
                          "datepicker__month-day--first-day-selected"
                          ...
                          : i.includes("datepicker__month-day--selected")
                          ? this.replacei18n(
                    ...
                    h && t[e].setAttribute("aria-label", h),
                    t[e].setAttribute("aria-disabled", n);
            }
        }
        replacei18n(t, e) {
        ...
        doKeyDown(t) {
            switch (t.keyCode) {
                case 39:
                    this.isOnFocus &&
                        (t.preventDefault(), this.setActiveDay("next"));
                    break;
                case 37:
                    this.isOnFocus &&
                        (t.preventDefault(), this.setActiveDay("prev"));
                    break;
                case 40:
                    this.isOnFocus &&
                        (t.preventDefault(), this.setActiveDay("down"));
                    break;
                case 38:
                    this.isOnFocus &&
                        (t.preventDefault(), this.setActiveDay("up"));
                    break;
                case 36:
                    this.isOnFocus &&
                ...
                case 35:
                    this.isOnFocus &&
                        (t.preventDefault(), this.setActiveDay("last"));
                    break;
                case 27:
                    this.isOnFocus &&
        ...
        setActiveDay(t) {
            ...
            if (
                ...
                const n = this.datepicker.querySelectorAll(
                    '[index="' + a + '"]'
                );
                if (n.length > 0 && a > 0) this.setDayFocus(n[0]);
                else if (a > 0) {
                    let e = "";
        ...
        setDayIndexes() {
            ...
            this.dayIndex = 1;
            for (let e = 0; e < t.length; e++)
                this.hasClass(t[e], "datepicker__month-day--visibleMonth")
