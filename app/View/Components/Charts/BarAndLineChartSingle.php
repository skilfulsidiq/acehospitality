...
class BarAndLineChartSingle extends Component
{
    public  $chartId;
    ...
    public $yname;
    public $colors;
    public function __construct($chartId, $seriesDataOne,$categories,$chartType="", $colors=[], $seriesNameOne = '',$seriesNameTwo="",  $yname="",$width=[])
    {
    ...
    {
        return view('components.charts.bar-and-line-chart-single');
    }
}
