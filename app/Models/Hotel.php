...
class Hotel extends Model
{
    ...
    protected $fillable = [ 'hotel_name', 'hotel_address', 'hotel_phone', 'hotel_email', 'hotel_cover_image', 'hotel_images', 'hotel_short_desc', 'hotel_desc', 'hotel_amenities', 'hotel_map'];
